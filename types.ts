...
export interface TranslationStructure {
  ...
  admin: {
    ...
    invoiceDesc: string;
    invoicePriceNet: string;
    invoiceVat: string;
    invoiceTotal: string;
    invoiceSumNet: string;
    invoicePlusVat: string;
  ...
  sections: {
    ...
    bookFormPhonePlaceholder: string;
    bookFormDate: string;
    bookFormTime: string;
